...
BOARD_H = 56 if VARIANT == "std" else 108
...
if VARIANT == "pro":
    PLACEMENT.update({
        ...
        "J18": (4.0, 74.0, 90), "J19": (4.0, 83.0, 90),  # SW3/SW4
        # SW conditioning (back) beside the SW terminals
        "R30": (10.0, 72.0, 0), "R32": (10.0, 74.0, 0), "C29": (10.0, 76.0, 0),
        "R31": (10.0, 81.0, 0), "R33": (10.0, 83.0, 0), "C30": (10.0, 85.0, 0),
        # ── front row 1 (y87): CH1-4 outputs ──
        "J8": (13.0, 87.0, 0), "J9": (25.0, 87.0, 0),
        "J10": (37.0, 87.0, 0), "J11": (48.0, 87.0, 0),
        # ── front row 2 (y76): CH5, CH6, BNC ──
        "J16": (6.0, 92.0, 0), "J17": (19.0, 92.0, 0),
        "J15": (44.0, 98.0, 180),
        # channel LEDs above their terminals (top)
        "D5": (15.5, 84.0, 0), "D6": (27.5, 84.0, 0),
        "D7": (39.5, 84.0, 0), "D8": (52.0, 84.0, 0),
        "D15": (8.0, 89.0, 0), "D16": (21.0, 89.0, 0),
        "R28": (8.0, 87.0, 0), "R29": (21.0, 87.0, 0),
        # ── pH island: PS1 top; ICs back, right of the terminals ──
        "PS1": (44.0, 72.0, 0),
        "U11": (56.0, 71.0, 0),
        "C22": (52.0, 69.0, 90), "C28": (62.0, 71.0, 90),
        "U9": (44.0, 80.0, 0),
        "C20": (40.0, 76.0, 0), "C27": (40.0, 84.0, 0),
        "C21": (50.0, 77.0, 0),
        "R26": (46.0, 88.0, 0), "R27": (50.0, 88.0, 0),
        "U8": (58.0, 79.0, 90),
        "U10": (58.0, 86.0, 0),
        "R24": (52.0, 84.0, 0), "R25": (54.0, 88.0, 0),
        "C25": (63.0, 86.0, 90), "C26": (63.0, 80.0, 90),
    })
